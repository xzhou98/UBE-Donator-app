...
function AppStackNavigator({ navigation }) {
        ...
        return (
            <DrawerContentScrollView {...props} style={{backgroundColor: '#dce7e9'}}>
                ...
                style={{  paddingVertical: 16 }}>
                    <Text style={{ margin: 16, fontWeight: 'bold', color: "#161924", }}>Sign Out</Text>
                </TouchableOpacity>
    ...
    return (
            <Drawer.Navigator initialRouteName="Home" drawerContent={props => <CustomDrawerContent {...props} />}>
                ...
                {currentUser?.email === 'zxy357038667@gmail.com' && <Drawer.Screen name="AddSeed" component={AddSeedScreen} />}
            </Drawer.Navigator>
    )
}
